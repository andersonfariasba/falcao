      ...
      <div class="x_title">
        ...
        <h2>Pesquisa de Solicitações</h2>
          <ul class="nav navbar-right panel_toolbox">
            <!-- Link de Cadastrar -->
            <li><a href="<?php echo site_url('solicitacao/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Nova Solicitação</strong></a></li>
            ...
            <tbody>
               ...
               <?php foreach ($list as $obj): ?>
                 <tr class="dadosTabela">
                  ...
                  <td><?php echo $objDateFormat->date_format($obj['data_solicitacao']); ?></td>
                  ...
                  <a href="<?php echo site_url('solicitacao/editar/'.$obj['id_solicitacao']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> Visualizar</a>
                  
                  <!-- Chama o model de exclusão -->
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $obj['id_solicitacao']; ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
                ...
                -->
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="cliente" value="<?php echo set_value('cliente')?>"/>
                    </div>
                  </div>
