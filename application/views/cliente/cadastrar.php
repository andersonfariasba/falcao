		...
		<div class="x_panel">
			...
			<div class="x_title">
				...
				<ul class="nav navbar-right panel_toolbox">
					<li><a href="<?php echo site_url('cliente/filtro'); ?>"><i class="fa fa-search"></i> <strong>Pesquisar</strong></a></li>
				</ul>                     
			...
			<div class="x_content"> 
				...
				<!-- Inicio do formuário -->
				<?php echo form_open('cliente/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
