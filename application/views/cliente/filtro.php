      ...
      <div class="x_title">
        ...
        <h2>Pesquisa de Clientes</h2>
          <ul class="nav navbar-right panel_toolbox">
            <!-- Link de Cadastrar -->
            <li><a href="<?php echo site_url('cliente/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Novo</strong></a></li>
            ...
            <tbody>
               ...
               <?php foreach ($list as $obj): ?>
                 <tr class="dadosTabela">
                  ...
                  <td><?php echo $objDateFormat->date_format($obj['data_cadastro']); ?></td>
                  ...
                  <a href="<?php echo site_url('cliente/editar/'.$obj['id_cliente']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  
                  <!-- Chama o model de exclusão -->
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $obj['id_cliente']; ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
...
$(function () {
 ...
 //Padrão
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('cliente/excluir'); ?>/"+id;
